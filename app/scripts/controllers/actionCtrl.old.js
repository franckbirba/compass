(function(){
  ...
  ActionController.$inject = ['$scope', 'Auth', 'actionService', 'buildingService', 'timelineCalculationService'];

  function ActionController($scope, Auth, actionService, buildingService, timelineCalculationService) {
